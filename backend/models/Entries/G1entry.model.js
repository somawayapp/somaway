...
const EntrySchema = new mongoose.Schema(
  {
    ...
    groupId: {
      type: String,
      required: true,
       default: "g1" // This will auto-assign "g1" unless overridden

    },
        total: {
       type: Number,
       required: true,
       default: "10" // This will auto-assign "g1" unless overridden
...
const EntryModel = mongoose.model("Entry1", EntrySchema);
