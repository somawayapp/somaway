...
const WinnerSchema = new mongoose.Schema(
  {
    ...
    phone: {
      ...
      type: String,
      required: true,
       default: "g5" // This will auto-assign "g1" unless overridden

    },
        total: {
       type: Number,
       required: true,
       default: "100000" // This will auto-assign "g1" unless overridden
...
const WinnerModel = mongoose.model("Winner5", WinnerSchema);
