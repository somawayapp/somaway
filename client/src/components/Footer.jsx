...
const Footer = () => {
  ...
  return (
    <footer className=" mt-5 px-3 md:px-9   mt-[50px] text-[var(--softTextColor)] md:mt-[70px] font-medium text-sm border-t border-[var(--softBg)]">
      <div className="container mx-auto grid pt-5  grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <nav>
            <ul className="space-y-2">
              <li><a href="/discover" className="text-[var(--softTextColor)] hover:text-[var(--softTextColor)]">Book Summaries</a></li>
              <li><a href="/discover" className="text-[var(--softTextColor)] hover:text-[var(--softTextColor)]">Blog</a></li>
