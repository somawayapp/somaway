...
const HowToJoin = () => {
  ...
  .
  To join, simply click the <strong>Join</strong> button above and provide your <strong className="mr-1">M-Pesa phone number (starting with 07...)</strong>
  ...
  </strong>. Once you confirm and enter your M-Pesa PIN, the amount will be automatically deducted and added to the community stash.
</p>


   <p className="text-gray-300 text-sm leading-relaxed">
  <strong>Participation Rules:</strong> Each phone number can only contribute once with <strong>1 KES</strong> to ensure fairness 
  and equal opportunity for all participants. To promote transparency and community trust, your name and a partially hidden phone number will
...
<p className="text-gray-300 text-sm leading-relaxed mt-4">
  <strong>Winner Selection:</strong> Once the total stash reaches <span className="text-[#ffd700] font-semibold">1,000,000 KES</span>,
   an automated, transparent hash-based draw will randomly select a winner. The selected individual will receive <strong className="mr-1">80%</strong>
