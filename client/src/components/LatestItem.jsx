...
const LatestItem = ({ post }) => {
  ...
  return (
      ...
      <div className="flex gap-2 md:gap-4 overflow-x-auto scrollbar-hide">
          <div
            className="flex flex-col  flex-shrink-0 w-[100px] w-[130px] md:w-[240px]"
          >
  ...
  className="text-[var(--softTextColor)] mt-2 ml-3 capitalize text-sm md:text-lg font-semibold"
>
  {post.author
