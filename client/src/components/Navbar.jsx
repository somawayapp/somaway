      ...
      if (isOpen) {
        ...
        document.body.style.overflow = "auto";
          ...
          <div  style={{ zIndex: 100004, }}
             className="flex justify-between  flex-col relative w-full  gap-3 py-2 md:py-3  md:gap-6 flex sticky top-[49px]  text-[var(--TextColor)] bg-[#027B5B] md:border-b  border-b-[var(--softBg4)] " >
