  ...
  return(
    ...
    className="top-0 w-full md:px-6 z-50 hidden md:flex mt-[-90px] flex-col items-center justify-center transition-all duration-300"
      >
        ...
        >
          <a href="?model=forrent" className="text-[16px] font-normal  text-[var(--softBg5)] hover:underline">
         For Rent
          </a>
          <a href="/reviews" className="text-[16px] font-semibold text-[var(--softTextColor)] hover:underline">
           Reviews
          </a>
          <a href="?model=forsale" className="text-[16px] font-normal text-[var(--softBg5)] hover:underline">
          For Sale
          </a>
        </div> )}
