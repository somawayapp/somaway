...
const Search2 = () => {
  ...
  style={{ zIndex: 100010 }}
  type="button"
  className="w-full block md:hidden border-[1px] mt-[-1px] border-[var(--softBg4)] rounded-full shadow-md  transition
...
>
  <div className="flex flex-row items-center relative gap-2 w-full justify-between">
    ...
    <div className="p-2 flex-shrink-0">
      <div className="p-2 bg-[#2F74FD]  rounded-full text-white transition-transform duration-300 hover:scale-110  hover:bg-[#0556f7]">
