...
<div className="hidden md:flex fixed flex-col h-screen min-w-[10%] w-[17%] border-r border-black py-4 overflow-y-auto whitespace-nowrap no-scrollbar min-w-fit">
