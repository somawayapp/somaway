...
const Sidebar2 = () => {
  ...
  const handleSearch = async (e) => {
    ...
    try {
      ...
      // Assuming your backend is at https://shilingiapi.vercel.app and search route is /api/search-participant
      const res = await fetch(`https://shilingiapi.vercel.app/search?phone=${encodeURIComponent(searchQuery.trim())}`);
      const data = await res.json();
