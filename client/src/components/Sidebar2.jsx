...
const Sidebar2 = () => {
  ...
  return (
    <div className="w-full md:pr-[25%] px-4 md:px-0 md:pl-[13%] md:py-5 overflow-y-auto h-[calc(98vh)] text-white flex flex-col items-center gap-4">
      {/* Gauge */}
     {/* Gauge */}
  ...
  >
    {searchLoading ? "Searching..." : "Search"}
      ...
      {searchResults.length > 0 && (
        <motion.div
          className="w-full text-center h-[fit-content] max-h-[calc(50vh)] overflow-y-auto"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
