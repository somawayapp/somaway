...
const Sidebar2 = () => {
  ...
  const radius = 70; // This variable is not used but was in your code.
      ...
      <div className="relative w-40 h-40 flex items-center justify-center">
        <svg className="w-full h-full rotate-[135deg]" viewBox="0 0 200 200">
          ...
          <motion.circle
            ...
            strokeLinecap="round"
            strokeDasharray="440"
            // CHANGE THIS LINE: Initialize strokeDashoffset to 440 to start hidden
            strokeDashoffset={440} // Changed from: {440 - (440 * displayedPercentage) / 100}
            animate={controls}
          />
          <defs>
      ...
      >
        ...
        <div className="relative flex-grow min-w-0">
          <input
            ...
            className="w-full px-3 pr-16 text-sm rounded-md bg-gradient-to-br from-[#070707ff] to-[#111] border-2 border-[#070707ff]
            ...
            onKeyPress={(e) => {
              if (e.key === 'Enter') {
                handleSearch(e); // Pass the event object
              }
            }}
          />
          <button
            onClick={handleSearch}
            className="absolute inset-y-0 right-0 bg-[#ffd700] px-3 text-sm text-gray-900 rounded-r-md font-semibold hover:bg-[#ffc107] transition-colors
