...
const Navbar = () => {
  ...
  return (
     ...
     <div style={{ zIndex: 100004 }}  className="relative w-full h-[45px] md:h-[55px] gap-4 flex items-center text-[var(--TextColor)]
      sticky top-0 justify-between bg-[var(--navbarbg)] border-b-2 border-b-[var(--textColore)] ">
      ...
      <span className="bg-clip-text text-[#0062e3]  pl-1 text-2xl md:text-3xl  font-extrabold">Somaway</span>
