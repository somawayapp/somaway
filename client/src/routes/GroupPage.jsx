...
<div> 
  ...
  <div className="flex md:flex-row relative"> 
    ...
    {/* Sidebar */}
    <div className="w-full hidden sticky top-[110px] md:block md:w-[22%] h-[98vh] overflow-y-auto border-r-2 border-[#1b1f1c]">
      <Sidebar />
    </div>
    ...
    <div className="flex-1 md:px-8">
     ...
     <div className="w-full hidden sticky top-[110px] md:block md:w-[22%] h-[90vh] overflow-y-auto border-l-2 border-[#1b1f1c]">
          <Sidebar2 />
    </div>
