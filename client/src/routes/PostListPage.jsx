...
<Helmet>
  <title>Unlock the Secrets of {title} - A Game-Changing Summary | Somaway</title>
  <meta 
    name="description" 
    content={`Delve into ${title} by ${author} - A deep dive into ${cat} that challenges conventional wisdom. Experience revolutionary self-growth with Somaway. The world's best book summaries, distilled for unstoppable success.`} 
  />
