  ...
  return (
    ...
    <div
       ...
       >
         ...
         <div className="h-full p-2 bg-[#7e02fa] mx-auto w-full max-w-[1200px] mt-[20px] md:mt-[70px] rounded-md md:rounded-[30px] shadow-md  box-border">
        ...
        <SignedIn>
         ...
         <div className="bg-[#7e02fa]  mx-auto w-full  max-w-[1200px] mb-[70px]  mt-[20px] md:mt-[70px] rounded-md md:rounded-[30px] shadow-md text-center">
