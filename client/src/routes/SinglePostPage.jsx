  ...
  return (
    <div className=" bg-[var(--navBg)]">
      ...
      <div className="flex flex-col p-2 md:p-8 gap-4">
        ...
        <h1 className="text-xl md:text-2xl font-semibold  text-left"> Library /
      ...
      <div className="flex flex-col bg-[var(--bg )] border-2 border-[var(--softTextColor2)] shadow-2xl rounded-2xl  p-2 md:p-4
