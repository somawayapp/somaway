...
<Helmet>
    <title>Unlock the Secrets of {data.title} by {data.author} | Somaway Book Summary</title>

    <meta name="description" content={`Discover ${data.title} by ${data.author} – A ${data.category} masterpiece! Explore key insights & life-changing ideas with Somaway summaries.`} />
