...
const SinglePostPage = () => {
  ...
  const renderPhoneNumber = (phone) => {
    return showFullContact ? phone : `${phone.slice(0, 7)}...`;
  };
...
<div className="w-full flex h-[300px] md:h-[500px] overflow-hidden rounded-xl relative transition duration-300">
      {/* Left Image */}
      <div className="flex-1 h-[300px] w-full md:h-[500px] overflow-hidden relative mr-1 md:mr-2 cursor-pointer">
        {mainImage && <img src={mainImage}  onClick={() => openPopup(0)} className="object-fill h-[300px] md:h-[500px] w-full" alt="Main Image" />}
