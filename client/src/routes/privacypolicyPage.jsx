...
const PrivacyPolicyPage = () => {
  return (
          ...
          (referred to as the “Site” or Sites” depending on the context). This Policy sets out how we collect, store,
          guard, share and use any personal data that we may collect from you when you use or otherwise interact with
        ...
        <ul className="list-disc list-inside  mb-4">
          ...
          <li>
            ...
            otherwise offered through the Site.
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside  mb-4">
          ...
          <li>
            <span className="font-semibold">Contact Information</span> such as your billing address, delivery address,
            email address and telephone numbers, the name of your business, and/or location.
          </li>
          <li>
          ...
          <li>
            ...
            identification or passport, KRA PIN certificate, business permits, company incorporation certificates,
            and/or location.
          </li>
          <li>
            <span className="font-semibold">Account information</span> relating to the use of the Site including profile
            data such as your username, password, orders, interests, preferences, survey responses and/or feedback.
          </li>
          <li>
            <span className="font-semibold">Automatic information and information about your device</span> including
            technical data (internet protocol (IP) address, login data, time zone setting, browser type and version,
            location, browser plug-in types and versions, operating system and platform, and/or other technology on the
            devices you use to access the Site. Note that this automatic information and device information is used to
            screen for potential risks and fraud, to improve and optimize the Site, to ease access to the Site, and to
            carry out upgrades, data analysis, and improve the quality of services. You can set your browser to refuse
            all or some browser cookies, but this will make parts of the Site inaccessible or inhibit functionality.
          </li>
          <li>
            <span className="font-semibold">Vehicle information</span> including vehicle identification and ownership
            documents.
          </li>
          <li>
            <span className="font-semibold">Marketing and communications data</span> such as your preferences in
        ...
        <ul className="list-disc list-inside  mb-4">
          ...
          <li>To perform a task in the consideration of the greater public interest.</li>
        ...
        <ul className="list-disc list-inside  mb-4">
          ...
          <li>Request erasure of false or misleading personal data. Note, however, that we may not always be able to comply with your request of erasure for specific legal reasons which will be notified to you, if applicable, at the time of your request.</li>
